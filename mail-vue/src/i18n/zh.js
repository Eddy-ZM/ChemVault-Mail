const zh = {
    ...
    archiveEmailsConfirm: '确认归档选中的邮件吗？',
    inbox: '收件箱',
    drafts: '草稿箱',
    sent: '已发送',
    starred: '星标邮件',
    ...
    SystemSettings: '系统设置',
    appConfig: 'App 配置',
    mailClientTitle: 'Outlook / 邮件客户端',
    mailClientSecurityTip: '不要在 Outlook 中填写 ChemVault 主账号密码，请在这里生成并使用 App Password。',
    incomingMail: '收信配置',
    outgoingMail: '发信配置',
    protocol: '协议',
    server: '服务器',
    ...
    oneTimePassword: '请立即复制此密码，它只会显示一次。',
    createdAt: '创建时间',
    lastUsedAt: '最后使用',
    status: '状态',
    revoked: '已撤销',
    revoke: '撤销',
    revokeAppPasswordConfirm: '确定撤销这个 App Password 吗？正在使用它的 Outlook 或邮件客户端将无法继续登录。',
    name: '名称',
    noMoreData: '没有更多数据了',
    ...
    avatarCustom: '自定义',
    chooseImage: '选择图片',
    emptyAvatarMsg: '请先选择图片或填写图片链接',
    invalidAvatar: '头像图片不正确',
    delete: '删除',
    refresh: '刷新',
    showAccounts: '显示邮箱账户',
    save: '保存',
    ...
    websiteReg: '用户注册',
    loginDomain: '隐藏登录域名',
    cloudflareAccess: 'Cloudflare 登录',
    ...
    about: '关于',
    version: '版本',
    windowsDesktopApp: 'Windows 桌面应用',
    downloadForWindows: '下载 Windows 版',
    windowsDownloadSummary: '在 Windows 10 或 Windows 11 上安装 ChemVault Mail，无需通过 Microsoft Store。桌面应用启动后会从 GitHub Releases 检查更新。',
    downloadWindowsInstaller: '下载安装程序',
    releaseNotes: '更新说明',
    currentVersion: '当前版本',
    installerFile: '安装包文件',
    ...
    unsignedBuildNoticeTitle: 'Windows 签名提醒',
    unsignedBuildNoticeBody: '正式 Windows 发布包应带有 Authenticode 代码签名。如果 Windows 显示“未知发布者”，请不要安装该文件，等待 ChemVault 发布已签名版本。',
    community: '交流',
    changeTitle: '修改标题',
