const en = {
    ...
    unsignedBuildNoticeTitle: 'Windows signing notice',
    unsignedBuildNoticeBody: 'Official Windows releases should be Authenticode signed. If Windows shows Unknown publisher, do not install that file; wait for a signed release from ChemVault.',
    community: 'Community',
