const en = {
    ...
    cloudflareAccessExternalPermsDesc: 'External email addresses signed in through Cloudflare Access can only use the selected read-only permissions. The server still rejects all edit requests.',
