const en = {
    ...
    archiveEmailsConfirm: 'Archive selected emails?',
    settings: 'Settings',
    analytics: 'Analytics',
    allUsers: 'All Users',
    allMail: 'All Mail',
    ...
    mailClientTitle: 'Outlook / Mail Client',
    mailClientSecurityTip: 'Do not use your main ChemVault password in Outlook. Generate and use an App Password here.',
    ...
    oneTimePassword: 'Copy this password now. It will only be shown once.',
    createdAt: 'Created',
    lastUsedAt: 'Last used',
    status: 'Status',
    revoked: 'Revoked',
    revoke: 'Revoke',
    revokeAppPasswordConfirm: 'Revoke this App Password? Outlook and other mail clients using it will stop working.',
    name: 'Name',
    ...
    avatarLogo: 'System Logo',
    avatarCustom: 'Custom',
    chooseImage: 'Choose Image',
    emptyAvatarMsg: 'Choose an image or enter an image URL',
    invalidAvatar: 'Invalid avatar image',
    delete: 'Delete',
    refresh: 'Refresh',
    ...
    cloudflareAccess: 'Cloudflare Sign-In',
    ...
    windowsDownloadSummary: 'Install ChemVault Mail on Windows 10 or Windows 11 without using Microsoft Store. The desktop app checks GitHub Releases for updates after launch.',
    downloadWindowsInstaller: 'Download Windows installer',
    ...
    unsignedBuildNoticeTitle: 'Unsigned build notice',
    unsignedBuildNoticeBody: 'This installer may show a Windows SmartScreen warning until ChemVault connects an EV or OV code signing certificate. Do not bypass SmartScreen with unsafe system changes.',
    community: 'Community',
